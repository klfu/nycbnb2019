...
-when opening jupyter notebook within this venv, was unable to import plotly.express,
 area, sklearn.neighbors
-decided to re-create new venv thru anaconda

-ran into memoryError when running code thru jupyter notebook
-created new venv in PyCharm
"""
# pip list

# 1. nyc_mappluto_20v7_shp\MapPLUTO.geojson
# 2. pluto_ziponly.geojson
nycmap = json.load(open("pluto_ziponly.geojson"))
# nycmap
...
fig = px.choropleth(df2,
                    ...
                    color="price",
                    locations="zip_code",
                    # ZipCode for MapPLUTO.geojson, zipcode for pluto.geojson
